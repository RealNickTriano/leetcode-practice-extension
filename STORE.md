...
> Spaced repetition for LeetCode. Your solves become flashcards — one problem
> a day, scheduled right before you'd forget it.

(132-character limit applies to the Chrome Web Store summary and the
`description` field in `manifest.json`.)

## Full description

**Stop re-grinding problems you already know. Stop forgetting the ones you
don't.**

Leetcode Anki turns LeetCode into a spaced-repetition deck, the same way Anki
works for flashcards — except the cards are problems, and a "review" means
solving one again from scratch.

**How it works**

1. Visit the LeetCode problems page. One recommended problem is pinned above
   the list: your most overdue review, or the next new problem from your
   queue.
2. Solve it. When the Accepted verdict appears, rate the recall — Again,
   Hard, Good, or Easy.
3. The scheduler (SM-2, Anki's algorithm) pushes the next review out on an
   expanding schedule: a day, six days, two weeks, a month. Problems you find
   easy fade into the future; problems that hurt come back soon.
...
Solving a problem once means you knew it that day. Spaced repetition is how
you'll know it in the interview.
